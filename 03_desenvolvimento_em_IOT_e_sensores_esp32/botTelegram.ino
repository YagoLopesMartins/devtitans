...
#define BOTtoken "6397432018:AAEUdKSMz_TK53ckf2fj1brQ7ZMH1H11W6o"
...
void handleNewMessages(int numNewMessages) {
    ...
    for (int i=0; i<numNewMessages; i++) {
        ...
        if( text == "/env") {
            ...
            message = "A temperatura é de " + String(temperature, 2) + "
            graus celsius.\n";
            message += "A umidade relativa do ar é de " + String(humidity,
            2)+ "%.\n";
        ...
        if (text == "/start") {
            String welcome = from_name + ", bem vindo ao Bot do
            DevTitans do Barreto.\n";
            welcome += "Para interagir, use um dos comandos a
            seguir.\n";
            welcome += "/ledon : para ligar o Led \n";
            welcome += "/ledoff : para desligar o Led \n";
            welcome += "/env : saber a temperatura e umidade do
            ambiente \n";
